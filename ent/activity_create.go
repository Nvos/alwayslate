...
func (ac *ActivityCreate) AddTimesheetIDs(ids ...int) *ActivityCreate {
	ac.mutation.AddTimesheetIDs(ids...)
	return ac
}

// AddTimesheets adds the "timesheets" edges to the Timesheet entity.
func (ac *ActivityCreate) AddTimesheets(t ...*Timesheet) *ActivityCreate {
	ids := make([]int, len(t))
	for i := range t {
		ids[i] = t[i].ID
	}
	return ac.AddTimesheetIDs(ids...)
}

// SetProjectID sets the "project" edge to the Project entity by ID.
func (ac *ActivityCreate) SetProjectID(id int) *ActivityCreate {
...
func (ac *ActivityCreate) createSpec() (*Activity, *sqlgraph.CreateSpec) {
	...
	if nodes := ac.mutation.TimesheetsIDs(); len(nodes) > 0 {
	...
	if nodes := ac.mutation.ProjectIDs(); len(nodes) > 0 {
		...
		_node.project_activities = &nodes[0]
		_spec.Edges = append(_spec.Edges, edge)
	}
	return _node, _spec
}
